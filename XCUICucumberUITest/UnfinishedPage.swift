//
//  UnfinishedPage.swift
//  XCUITodo
//
//  Created by Tegar on 9/12/16.
...
class UnfinishedPage: BasePage {
    ...
    static func verifyUnfinishedPage(){
        let app = XCUIApplication()
        XCTAssert(app.staticTexts["Unfinished"].exists)
    }
